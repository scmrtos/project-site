...
В настоящее время **scmRTOS** поддерживает ряд целевых платформ, с перечень которых приведён в [Таблице поддерживаемых платформ](platforms.md#platforms-supported-targets).
