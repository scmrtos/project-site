...
!!! tip "**СОВЕТ**"
    ...
    История появления **scmRTOS** и некоторые "философские" замечения на тему операционных систем реального времени приведены в [PDF документе](https://github.com/scmrtos/scmrtos-doc/blob/master/attic/pdf/scmRTOS.ru.pdf)
