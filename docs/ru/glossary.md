...
Программные объекты, расширяющие функциональность операционной системы, но не в входящие в основой5 состав ОС. Примером расширения может служить [профилировщик работы процессов системы](profiler.md).
