...
**scmRTOS** способна выполняться на совсем крошечных МК, имеющих объём оперативной памяти порядка 512 байт. Она написана на языке программирования С++ и поддерживает [ряд платформ](#index-supported-targets). Подробное описание ОС приведено в следующих разделах. Кроме того, доступна [версия документации в формате PDF](https://github.com/scmrtos/scmrtos-doc/blob/master/scmrtos-ru.pdf).
...
Полный архив, включающий исходный код ОС, примеры, документацию и др., также можно скачать со [ страницы релизов проекта](https://github.com/scmrtos/scmrtos/releases/).
