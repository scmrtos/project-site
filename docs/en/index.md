...
**scmRTOS** is capable to run on tiny uCs with as small amount of RAM as 512 bytes. The RTOS is written on C++ and supports [various platforms](platforms.md#platforms-supported-targets). See next sections and [online documentation](https://scmrtos.github.io) for more details.
...
[^index-1]: Distribution includes PDF documents. It's recommended to use [online documentation](https://scmrtos.github.io), as it is updated more frequently and contains all the latest changes.
